...
namespace Jal.Router.Impl.Inbound
{
    ...
    {
        public void Execute<TContent, THandler>(IndboundMessageContext<TContent> context, RouteMethod<TContent, THandler> routemethod, THandler handler) where THandler : class
        {
        ...
        public void Execute<TContent, THandler, TData>(IndboundMessageContext<TContent> context, RouteMethod<TContent, THandler> routemethod, THandler handler, TData data) where THandler : class
        {
            if (routemethod.ConsumerWithContext != null)
            {
                routemethod.ConsumerWithContext(context.Content, handler, context);
