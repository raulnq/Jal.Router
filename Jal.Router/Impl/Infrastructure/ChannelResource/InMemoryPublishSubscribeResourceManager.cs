...
{
    public class InMemoryPublishSubscribeResourceManager : AbstractInMemoryResourceManager
    {
        public InMemoryPublishSubscribeResourceManager(IInMemoryTransport transport) : base(transport)
        {
        }
