...
{
    public class InMemorySubscriptionToPublishSubscribeChannel : AbstractChannel, ISubscriptionToPublishSubscribeChannel
    {
        ...
        public InMemorySubscriptionToPublishSubscribeChannel(IParameterProvider provider, IComponentFactoryFacade factory, ILogger logger, IInMemoryTransport inmemorysystem) : base(factory, logger)
        {
