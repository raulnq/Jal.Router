...
namespace Jal.Router.Tests
{
    ...
    {
        private PublishSubscribeChannelResourceCreator Build(IComponentFactoryGateway factory)
        {
            return new PublishSubscribeChannelResourceCreator(factory, new NullLogger());
        }
        ...
        public async Task Run_WithError_ShouldThrowException()
        {
            ...
            channelresource.Setup(x => x.CreateIfNotExist(It.IsAny<PublishSubscribeChannelResource>())).Throws(new Exception());
            ...
            channelresource.Verify(x => x.CreateIfNotExist(It.IsAny<PublishSubscribeChannelResource>()), Times.Once);
        }
