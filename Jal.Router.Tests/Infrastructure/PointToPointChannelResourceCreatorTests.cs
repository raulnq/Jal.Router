...
namespace Jal.Router.Tests
{
    ...
    public class PointToPointChannelResourceCreatorTests
    {
        ...
        public async Task Run_WithError_ShouldThrowException()
        {
            ...
            channelresource.Setup(x => x.CreateIfNotExist(It.IsAny<PointToPointChannelResource>())).Throws(new Exception());
            ...
            channelresource.Verify(x => x.CreateIfNotExist(It.IsAny<PointToPointChannelResource>()), Times.Once);
        }
