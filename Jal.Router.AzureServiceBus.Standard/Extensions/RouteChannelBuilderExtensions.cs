...
namespace Jal.Router.AzureServiceBus.Standard
{
    ...
    public static class RouteChannelBuilderExtensions
    {
        ...
        {
            return builder.AddPointToPointChannel(path, connectionstring, typeof(AzureServiceBusMessageAdapter), typeof(AzureServiceBusQueue), connection?.ToDictionary());
        }
        ...
        {
            return builder.AddSubscriptionToPublishSubscribeChannel(path, subscription, connectionstring, typeof(AzureServiceBusMessageAdapter), typeof(AzureServiceBusSubscription), connection?.ToDictionary());
        }
    }
}